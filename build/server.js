...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _benchRest = __webpack_require__(46);
  
  var _benchRest2 = _interopRequireDefault(_benchRest);
  ...
  var parseJade = function parseJade(path, jadeContent) {
  	...
  	return Object.assign({
  		path: path, content: htmlContent
  	}, fmContent.attributes);
  };
  
  var router = new _express.Router();
  
  router.post('/bench', function callee$0$0(req, res, next) {
  	return regeneratorRuntime.async(function callee$0$0$(context$1$0) {
  		while (1) switch (context$1$0.prev = context$1$0.next) {
  			case 0:
  				try {
  					(function () {
  						...
  						var endpoint = _url2['default'].format({
  						...
  						var errors = [];
  						(0, _benchRest2['default'])(flow, runOptions).on('error', function (err) {
  							errors.push(err);
  ...
  router.get('/', function callee$0$0(req, res, next) {
  	...
  	return regeneratorRuntime.async(function callee$0$0$(context$1$0) {
  		while (1) switch (context$1$0.prev = context$1$0.next) {
  			...
  			case 16:
  				context$1$0.next = 18;
  				return regeneratorRuntime.awrap(_utilsFs2['default'].readFile(fileName, {
  					encoding: 'utf8'
  				}));
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                'a',
                { href: 'http://github.com/ninnemana' },
                '@ninnemana'
              )
            ),
            _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                'Plugin a series of API endpoints and watch them battle for speed.'
              )
            )
          )
        );
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Navigation = (function (_Component) {
    ...
    _createClass(Navigation, [{
      key: 'render',
      value: function render() {
        return _react2['default'].createElement('div', { className: (0, _classnames2['default'])(this.props.className, 'Navigation'), role: 'navigation' });
      }
    }], [{
      key: 'propTypes',
      value: {
  	...
  	on('*', function callee$1$0(state) {
  		return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
  			while (1) switch (context$2$0.prev = context$2$0.next) {
  				case 0:
  					console.log(state);
  					return context$2$0.abrupt('return', _react2['default'].createElement(_componentsContentPage2['default'], null));
...
/***/ function(module, exports) {
  ...
  module.exports = require("bench-rest");
